...
func SPARQL(db store.GraphStore) http.HandlerFunc {
	h := sparql.New(db)
	return h.ServeHTTP
}
...
func BeamlineSPARQL(db store.GraphStore) http.HandlerFunc {
